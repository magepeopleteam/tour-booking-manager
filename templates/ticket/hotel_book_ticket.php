...
if ( $has_valid_nonce ) {
	...
	if ( $hotel_id && $date_range ) {
		...
		<div class="ttbm_hotel_room_panel ttbm_default_widget mT">
			<h3 class="ttbm_hotel_room_panel__title">
				...
				<table class="mp_tour_ticket_type ttbm_hotel_room_table">
					...
					foreach ( $room_lists_new as $ticket ) {
						...
						<tr class="ttbm_hotel_room_row">
							...
							<td class="ttbm_hotel_room_col--qty ttbm_hotel_room_incDec" data-label="<?php echo esc_attr( TTBM_Function::ticket_qty_text() ); ?>">
