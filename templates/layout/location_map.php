<?php
	...
	$full_address = TTBM_Function::get_post_info( $ttbm_post_id, 'ttbm_full_location_name' );
	if ( $full_address && TTBM_Function::get_post_info( $ttbm_post_id, 'ttbm_display_map', 'on' ) != 'off' ) {
		?>
