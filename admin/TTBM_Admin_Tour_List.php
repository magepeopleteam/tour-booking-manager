				...
				<div class="wrap travel-list">
					<div class="mpStyle">
						<div class="_dLayout_pRelative placeholder_area " id="ttbm_list_page">
							<button class="_navy_blueButton_xs rounded" type="button" data-href="<?php echo esc_url(admin_url('post-new.php?post_type=' . TTBM_Function::get_cpt_name())); ?>" title="<?php esc_attr_e('Add New', 'tour-booking-manager'); ?>">
