                    ...
                    if ($ttbm_id && get_post_type($ttbm_id) === 'ttbm_tour') {
                        ...
                        if ($existing_req) {
                            ...
                            if ($req_status === 'approved') {
                                ...
                                $cancel_status = '<span style="color:orange;font-weight:bold;">' . esc_html__('Pending', 'tour-booking-manager') . '</span>';
                            }
        ...
        .then(function(data) {
            ...
            if (data.success) {
                ...
                if (row) {
                    ...
                    if (actionCell) {
                        actionCell.innerHTML = '<span style="color:green;font-weight:bold;">' + data.message + '</span>';
                        actionCell.style.color = '#2ecc40';
