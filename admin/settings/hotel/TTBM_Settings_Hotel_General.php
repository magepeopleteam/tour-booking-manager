		...
		class TTBM_Settings_Hotel_General {
			...
			public function save_hotel_general_settings($post_id) {
				if (get_post_type($post_id) == 'ttbm_hotel') {
					$ttbm_display_location = TTBM_Global_Function::get_submit_info('ttbm_display_hotel_location') ? 'on' : 'off';
					$ttbm_location_name = TTBM_Global_Function::get_submit_info('ttbm_hotel_location');
					...
					/***************/
					$ttbm_display_distance = TTBM_Global_Function::get_submit_info('ttbm_display_hotel_distance') ? 'on' : 'off';
					$ttbm_hotel_distance_des = TTBM_Global_Function::get_submit_info('ttbm_hotel_distance_des');
