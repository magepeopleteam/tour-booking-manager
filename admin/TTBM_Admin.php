	...
	if (!class_exists('TTBM_Admin')) {
		class TTBM_Admin {
			...
			private function load_ttbm_admin() {
				...
				require_once TTBM_PLUGIN_DIR . '/admin/settings/tour/TTBM_Settings_Schedule_Planner.php';
				require_once TTBM_PLUGIN_DIR . '/admin/settings/tour/TTBM_Settings_Capacity_Override.php';
				...
				require_once TTBM_PLUGIN_DIR . '/admin/settings/tour/TTBM_Settings_Template.php';
				...
				require_once TTBM_PLUGIN_DIR . '/admin/settings/hotel/TTBM_Settings_Hotel_Activity.php';
