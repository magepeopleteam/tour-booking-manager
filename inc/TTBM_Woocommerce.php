						...
						<ul class="cart_list">
							...
							<?php if ( sizeof( $hotel_info ) > 0 ) { ?>
								<li>
									...
									<h6><?php echo esc_html__( 'Hotel Name', 'tour-booking-manager' ); ?> :</h6>&nbsp;
									<span><?php echo get_the_title( $hotel_info['hotel_id'] ); ?></span>
								</li>
								<li>
									<span class="far fa-calendar-check"></span>
									<h6><?php echo esc_html__( 'Checkin Date : ', 'tour-booking-manager' ); ?></h6>&nbsp;
									<span><?php echo esc_html( $hotel_info['ttbm_checkin_date'] ); ?></span>
								</li>
								<li>
									<span class="fas fa-calendar-times"></span>
									<h6><?php echo esc_html__( 'Checkout Date : ', 'tour-booking-manager' ); ?></h6>&nbsp;
									<span><?php echo esc_html( $hotel_info['ttbm_checkout_date'] ); ?></span>
								</li>
								<li>
									<span class="fas fa-stopwatch"></span>
									<h6><?php echo esc_html__( 'Duration : ', 'tour-booking-manager' ); ?></h6>&nbsp;
						...
						<?php foreach ( $ticket_type as $ticket ) { ?>
							<div class="dLayout_xs">
								<ul class="cart_list">
									<?php if ( sizeof( $hotel_info ) > 0 ) { ?>
										<li>
											<h6><?php echo esc_html__( 'Room Name', 'tour-booking-manager' ); ?> :</h6>&nbsp;
				...
				if ( sizeof( $ticket_info ) > 0 ) {
					...
					foreach ( $ticket_info as $_ticket ) {
						...
						for ( $key = 0; $key < $qty; $key ++ ) {
							...
							$zdata[ $count ]['ttbm_ticket_total_price'] = ( $_ticket['ticket_price'] * $_ticket['ticket_qty'] ) * $num_of_day;
