<?php
	...
	if ( $active_tour_guide == 'yes' && sizeof( $guides ) > 0 && TTBM_Function::get_post_info( $tour_id, 'ttbm_display_tour_guide', 'off' ) != 'off' ) {
		?>
		<div class='mpStyle ttbm_wraper' id="ttbm_tour_guide">
			<div class='ttbm_default_widget'>
				<?php do_action( 'ttbm_section_title', 'ttbm_string_tour_guide', esc_html__( 'Meet our guide ', 'tour-booking-manager' ) ); ?>
				<?php
					if ( sizeof( $guides ) > 1 ) {
