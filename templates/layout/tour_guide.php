<?php
	...
	if (sizeof($guides) > 0 && TTBM_Global_Function::get_post_info($ttbm_post_id, 'ttbm_display_tour_guide', 'off') != 'off') {
		...
		?>
		<div class='ttbm_style ttbm_wraper ttbm_tour_guide' <?php if (sizeof($guides) > 1 && $ttbm_guide_style=='carousel') { ?>  id="ttbm_tour_guide"<?php } ?>>
					...
					<?php foreach ($guides as $guide_id) { ?>
						<div class="">
							<div class="bg_image_area mb" data-placeholder>
								<div class="<?php echo esc_attr($ttbm_guide_image_style); ?>" data-bg-image="<?php echo TTBM_Global_Function::get_image_url($guide_id); ?>">
